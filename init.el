...
;;;; Org
     ...
     (org
      ...
      org-pomodoro-killed-sound (concat my-org-pomodoro-sound-dir "wrapper (norm).wav")
...
;;;; Packages
   ...
   '(
     ...
     dash-functional ;; 2021-03-10: NOTE: Spacemacs workaround
     )
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; (default nil)
   dotspacemacs-server-socket-dir "/run/user/1000/emacs"
...
;;;;; my-local-org-haskell-book-publish
  ...
  (defun my-org-haskell-book-publish ()
...
;;;;; my-org-haskell-book-open-hack

  (defun my-org-haskell-book-open-hack ()
...
;;;;; my-add-visual-replacement
  ...
  ;; from: https://emacs.stackexchange.com/a/34882/25552
...
;;;;; Haskell symbols
  ...
  (add-hook
   'haskell-mode-hook
   (lambda ()
     (mapc (lambda (pair) (my-add-visual-replacement (car pair) (cdr pair)))
           '(
             ;; Syntax
             ;; 𝈀
             ...
             ("instance"    . "𝐈")
             ("import"      . "i     ")
             ("qualified"   . "Q        ") ;; Q Ⴓ Ⴍ ↀ 🍘 Ꙕ Ƣ ᗩ 𝚀 ℺ ⵕ 𝚀 𝖰 Ձ Ԛ
             ("module"      . "m")
             ("LANGUAGE"    . "ℒ")  ;ム
             ("deriving"    . "ට")  ;ᘐ ච ᘑ
             ("data"        . "𝗗")
...
;;;; Workaround of a evil search & 'v'/'d' bug
...
;;;; LSP tuning performance
  ...
  (setq lsp-file-watch-ignored-directories '("[/\\\\]\\.git\\'" "[/\\\\]\\.hg\\'" "[/\\\\]\\.bzr\\'" "[/\\\\]_darcs\\'" "[/\\\\]\\.svn\\'" "[/\\\\]_FOSSIL_\\'" "[/\\\\]\\.idea\\'" "[/\\\\]\\.ensime_cache\\'" "[/\\\\]\\.eunit\\'" "[/\\\\]node_modules" "[/\\\\]\\.fslckout\\'" "[/\\\\]\\.tox\\'" "[/\\\\]dist\\'" "[/\\\\]dist-newstyle\\'" "[/\\\\]\\.stack-work\\'" "[/\\\\]\\.bloop\\'" "[/\\\\]\\.metals\\'" "[/\\\\]target\\'" "[/\\\\]\\.ccls-cache\\'" "[/\\\\]\\.vscode\\'" "[/\\\\]\\.deps\\'" "[/\\\\]build-aux\\'" "[/\\\\]autom4te.cache\\'" "[/\\\\]\\.reference\\'" "[/\\\\]\\.lsp\\'" "[/\\\\]\\.clj-kondo\\'" "[/\\\\]\\.cpcache\\'" "[/\\\\]bin/Debug\\'" "[/\\\\]obj\\'")
   )
  ...
  (add-to-list 'lsp-file-watch-ignored-directories "[/\\\\]\\real-store\\'")
